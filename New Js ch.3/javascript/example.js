/* This script is inside an immediately invoked function expression which
...
var hotel = {
  name: 'JXN',
  roomRate: 190, //Amount in dollars
  discount: 5,  // Percentage discount
  offerPrice: function() {
	var offerRate = this.room * ((100 - this.discount) / 100);
	return offerRate;
  }
};
...
specialRate.textContent = '$' + offerPrice(); //write offer price
...
function offerExpires(today) {
  ...
  daysName = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday',
   'Friday', 'Saturday'];
